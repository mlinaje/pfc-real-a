...
public class RedireccionPublico extends HttpServlet {

 	private static final long serialVersionUID = 1L;
 	
 	/** Constantes jsp's a redireccionar **/
 	private final String jspNormal = "indexNormalPublica.jsp";
 	private final String jspMobile = "indexMobilePublica.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
	        ...
	        if (log.isInfoEnabled()) log.info("* RedireccionPublico.processRequest*******************************");
	        ...
	        if (log.isInfoEnabled()) log.info("* FIN RedireccionPublico.processRequest***************************");
	        if (log.isInfoEnabled()) log.info("******************************************************************");
